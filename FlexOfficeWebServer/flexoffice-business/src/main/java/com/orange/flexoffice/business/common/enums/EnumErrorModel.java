...
public enum EnumErrorModel {
	...
	ERROR_64("DB001","impossible de charger la liste des dashboards"),
	ERROR_65("DB002","impossible de créer ce dashboard"),
	ERROR_66("DB003","impossible de mettre à jour ce dashboard"),
	ERROR_67("DB004","impossible de supprimer ce dashboard"),
	ERROR_68("DB005","impossible de charger ce dashboard"),
