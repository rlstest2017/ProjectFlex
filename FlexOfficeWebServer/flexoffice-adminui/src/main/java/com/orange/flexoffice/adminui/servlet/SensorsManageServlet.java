...
import com.orange.flexoffice.business.facade.SensorsManageFacade;
...
/**
 * Servlet implementation class SensorsManageServlet
 * @author oab
 */
public class SensorsManageServlet extends HttpServlet {
    ...
    /**
     * SensorsManageFacade
     *                  sensorsManageFacade parameter
     */
    private transient SensorsManageFacade sensorsManageFacade;
     ...
     */
    private static final Logger LOGGER = Logger.getLogger( SensorsManageServlet.class );

    /**
     * @see HttpServlet#HttpServlet()
     */
    public SensorsManageServlet() {
        super();
    }
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        this.sensorsManageFacade = (SensorsManageFacade) springContext.getBean("sensorsManageFacade");
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        LOGGER.info( "Begin call doGet method for SensorsManageServlet at: " + new Date() );
        ...
        LOGGER.info( "End call doGet method for SensorsManageServlet at: " + new Date() );
