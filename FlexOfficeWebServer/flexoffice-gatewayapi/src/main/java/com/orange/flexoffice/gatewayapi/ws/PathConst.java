...
public final class PathConst {
	...
	// Resources ID
	public static final String SENSOR_ID_PATH = "/{" + ParamsConst.SENSOR_IDENTIFIER_PARAM + "}";
	public static final String GATEWAY_ID_PATH = "/{" + ParamsConst.GATEWAY_MAC_ADDRESS_PARAM + "}";
